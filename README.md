...
> Hyper binary, linear, interpolation search

[![PyPI version](https://badge.fury.io/py/hyper-search-algos.svg)](https://pypi.org/project/hyper-search-algos/)
...
```bash
pip install hyper-search-algos
```

## Quick Start

```python
from hyper_search_algos import algos

# Basic usage
result = algos("your input here")
print(result)
```
...
result = algos("Hello World")

# Example 2: Batch processing
from hyper_search_algos import batch
